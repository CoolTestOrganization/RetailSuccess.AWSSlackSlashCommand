...
```
    cd "RetailSuccess.AWSSlackSlashCommand"
    dotnet restore
```

Execute unit tests
```
    cd "RetailSuccess.AWSSlackSlashCommand/test/RetailSuccess.AWSSlackSlashCommand.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "RetailSuccess.AWSSlackSlashCommand/src/RetailSuccess.AWSSlackSlashCommand"
